...
export const QUERY_ALL_FORMS_FIELD_API_URL = '/api/queryAllFormsField'
export const GET_REQEUSTS_COUNT_API_URL = '/api/getRequestsCount'
export const CHECK_EXISTENCE_VALUE_API_URL = '/api/checkExistenceValue'
export const REGISTER_SURVEY_API_URL = '/api/registerSurvey'
export const GET_SURVEY_API_URL = '/api/getSurvey'
